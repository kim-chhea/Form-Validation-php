    ...
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg">
        ...
        <form action="process.php" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input name="password" type="password" class="w-full px-4 py-2 mt-1 border rounded-lg focus:ring focus:ring-blue-300"
                    placeholder="********" required>
            </div>
            <div>
                <label class="block  text-sm font-medium text-gray-600">Confirm Password</label>
                <input name="confirm-password" type="password" class="w-full px-4 py-2 mt-1 border rounded-lg focus:ring focus:ring-blue-300"
                    placeholder="********" required>
            </div>
            <button type="submit"
